...
<body>
    ...
    <div class="container-fluid p-1">
        <div class="container py-1">
            <div class="row">
                <div class="col-lg-6">
                    <h1 class="position-relative mb-5">Daftar Pesanan Anda</h1>
                </div>
            </div>
            <div class="row">
            <?php 
                ...
                INNER JOIN keranjang ON pesanan.id_keranjang = keranjang.id_keranjang
                INNER JOIN pelanggan ON keranjang.username_pel = pelanggan.username_pel
                INNER JOIN produk ON keranjang.id_produk = produk.id_produk 
                WHERE pelanggan.username_pel = '$user'
                AND pesanan.status_pesanan <> 1
                GROUP BY pesanan.id_pesanan");
                while($hasil = mysqli_fetch_array($tampil)){
                        // Tampilkan hanya pesanan yang belum diproses
            ?>
                <div class="col-4">
                    <div class="card">
