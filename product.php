    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <h1 class="position-relative text-center mb-5">Nikmati Setiap Menu di Toko Kami</h1>
                </div>
            </div>
                ...
                <div class="col-lg-3 col-md-6 mb-4 pb-2">
                    <div class="product-item d-flex flex-column align-items-center text-center bg-light rounded py-5 px-3">
                        <div class="bg-primary mt-n5 py-3" style="width: 80px;" style="background-color:#E14F7D;">
                            <h4 class="font-weight-bold text-white mb-0"><?php echo $hasil['harga_produk']; ?></h4>
                        </div>
                        ...
                        <h5 class="font-weight-bold mb-4">Stok : <?php echo $hasil['stok']; ?></h5>
                        <?php 
                            if(!isset($_SESSION['username'])){?>
