            ...
            <div class="row text-center py-5">
                <div class="col-md-3">
                    <div class=" service-img mx-auto">
                        <img class="rounded-circle w-50 h-50 bg-light p-1" src="img/langkah1.jpeg" style="object-fit: cover;">
                    </div>
                ...
                <div class="col-md-3">
                    <div class=" service-img mx-auto">
                        <img class="rounded-circle w-50 h-50 bg-light p-1" src="img/langkah2.jpeg" style="object-fit: cover;">
                    </div>
                ...
                <div class="col-md-3">
                <div class=" service-img mx-auto">
                        <img class="rounded-circle w-50 h-50 bg-light p-1" src="img/langkah3.jpeg" style="object-fit: cover;">
                    </div>
                ...
                <div class="col-md-3">
                    <div class=" service-img mx-auto">
                        <img class="rounded-circle w-50 h-50 bg-light p-1" src="img/langkah4.jpeg" style="object-fit: cover;">
                    </div>
