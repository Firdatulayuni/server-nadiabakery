    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <h1 class="position-relative text-center mb-5">Nadia Bakery<br>Menu Dengan Resep Original</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 py-5">
                    <h4 class="font-weight-bold mb-3">About Us</h4>
                    <h5 class="text-muted mb-3">Mengapa Memilih Kami?</h5>
                    <p>Nadia Bakery menyediakan banyak jenis roti, dengan kualitas roti yang baik. Yang disukai banyak orang, roti biasanya dimakan saat sarapan sebagai makanan pengganti nasi atau mengganjal perut ketika lapar.</p>
                    <p>Manjakan lidah Anda dengan kelezatan kami! Jangan lewatkan kesempatan untuk mencicipi kreasi kue terbaik kami! Segera kunjungi toko kue kami dan rasakan sensasi manis yang tak terlupakan.</p>
                </div>
                ...
                <div class="col-lg-4 py-5">
                    <h4 class="font-weight-bold mb-3">Nadia Bakery</h4>
                    <h5 class="text-muted mb-3">Apa Yang Toko Kami Sediakan?</h5>
                    <p>Nadia Bakery adalah sebuah tempat untuk memproduksi dan menjual makanan yang berbahan dasar tepung dan dipanggang di dalam oven, seperti roti, kukis, kue, pastri, brownies, pai, dan lain sebagainya.</p>
                    <p>Ciptakan momen manis yang tak terlupakan dengan kue-kue dari toko kami. Kami menjamin kepuasan lidah Anda dengan setiap kunjungan. Pilih dari koleksi kami yang beragam dan nikmati tiap gigitan yang memanjakan.</p>
                </div>
            </div>
        </div>
    </div>
