        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h1 class="display-3 text-white mb-md-4">NADIA BAKERY</h1>
                            <h4 class="text-white text-uppercase mb-md-3">Rasakan Sentuhan Kelezatan Di Setiap Gigitan Roti Nadia</h4>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h1 class="display-3 text-white mb-md-4">ENAK & BERGIZI</h1>
                            <h4 class="text-white text-uppercase mb-md-3">Penyemangat Hari Anda Ada Di Balik Roti Kami</h4>
                            <a href="product.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Lihat Menu</a>
                        </div>
                    </div>
                </div>
