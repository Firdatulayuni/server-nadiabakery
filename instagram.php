    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            ...
            <div class="row text-center inline-block py-5">
                <a href="https://instagram.com/nadiabakery2010?igshid=MmJiY2I4NDBkZg==" title="Menuju platform Instagram" target="_blank">
                    <img class="w-100" src="img/instagram.jpeg" alt="image">
                </a>
            </div>
        </div>
    </div>
